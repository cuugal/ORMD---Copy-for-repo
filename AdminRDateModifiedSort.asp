							...
							<% if not rsSearchH.EOF then 
								  ...
								  <table border="2" width="85%" id="table1" bordercolor="#FFFFFF">
									<tr>
										...
										<a href="AdminRDateModified.asp?numOptionId=1&cboValDummy=0">
										...
										<a href="AdminRDateModified.asp?numOptionId=2&cboValDummy=0">
										...
										<td height="21" width="111">
										<b><font color="#800000" size="2" face="Tahoma">
										<a href="AdminRDateModified.asp?numOptionId=3&cboValDummy=0">
										<span style="text-decoration: none">Date Actions Completed</span></a></b></td>
										
										<td height="21" width="111">
										<font color="#800000" size="2" face="Tahoma"><b>
										<a href="AdminRDateModified.asp?numOptionId=4&cboValDummy=0">
								  ...
								  while not rsSearchH.EOF 
								    ...
								    'Response.Write("Expection caught")
											...
											<tr>
												...
												<td width="111">    <%if rsSearchH(12)= true then %><a target="_blank" href="http://www.ehs.uts.edu.au/forms/swms.doc">Safe Work Method Statements</a> <%end if%><BR>
						...
						if not rsSearchH.EOF then 
							  ...
							  <table border="2" width="85%" id="table1" bordercolor="#FFFFFF">
								<tr>
									<td width="314" height="21"><b>
									<font face="Tahoma" size="2" color="#800000">
									<a href="AdminRDateModified.asp?numOptionId=1&cboValDummy=1">
									<span style="text-decoration: none">Hazardous Task</span></a></b></td>
									<td width="314" height="21"><b>
		                                 <font face="Tahoma" size="2" color="#800000">
		                                  Hazards</b></td>
									...
									<td height="21">
									<b><font color="#800000" size="2" face="Tahoma">
									<a href="AdminRDateModified.asp?numOptionId=2&cboValDummy=1">
									<span style="text-decoration: none">Risk Level</span></a></b></td>
									<td height="21" width="111">
									<b><font size="2" face="Tahoma" color="#800000">Further Actions</b></td>
									<td height="21" width="111">
									...
									<td height="21" width="111">
									<b><font color="#800000" size="2" face="Tahoma">
									<a href="AdminRDateModified.asp?numOptionId=3&cboValDummy=1">
									<span style="text-decoration: none">Date Actions Completed</span></a></b></td>
									<td height="21" width="111">
									<font color="#800000" size="2" face="Tahoma"><b>
									<a href="AdminRDateModified.asp?numOptionId=4&cboValDummy=1">
									<span style="text-decoration: none">Renewal Date</span></a></b></td>
								</tr>
								<%
							  while not rsSearchH.EOF 
