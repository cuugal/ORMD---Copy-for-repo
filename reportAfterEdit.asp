...
%>
        ...
        <tr>
          <!--td><a title="Click to edit this Risk Assessment." href="EditQORA.asp?numCQORAId= <%=rsShow("numQORAId")%> "><%=rsShow("strtaskDescription")%></a></td-->
		  <td><%=rsShow("strtaskDescription")%></td>
